...
def ditillation_data_processing(student_data, teacher_data, student_tokenizer, teacher_tokenizer, config):
    data = {"input_ids":[], "attention_mask":[], "teacher_input_ids":[], "teacher_attention_mask":[]}
    for i in range(len(student_data)):
        ...
        steacher_padded = teacher_tokenizer.pad(
            teacher_data[i],
            padding="max_length",
            max_length=config["model"]["max_seq_len"],
        )
        data["input_ids"].append(student_padded["input_ids"])
        data["attention_mask"].append(student_padded["attention_mask"])
