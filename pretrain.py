...
from data import read_data, preprocess_data, tokenize_data, load_processed_data, save_processed_data
...
def main(args, config):
    ...
    if args.load_processed_data:
        ...
        data = load_processed_data(tokenizer, config)
    else:
        print("read raw data ...")
    ...
    val_size = config["train"]["val_size"]//config["train"]["batch_size"]
    train_size = len(data)-val_size
    val_data, train_data = random_split(data, [val_size, train_size])
    print(f"number of train input data: {len(train_data)*config['train']['batch_size']}")
    print(f"number of val input data: {len(val_data)*config['train']['batch_size']}")
